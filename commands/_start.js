...
if (request.chat && request.chat.type == "group") {
  ...
  Api.sendPhoto({
    ...
    reply_markup: {
      inline_keyboard: [
        ...
        [
          { text: "JOIN", url: "https://t.me/JackXsparrow_GC" }
        ],
        [
  ...
  if (!User.getProperty("isStarte")) {
    ...
    Api.sendMessage({
      chat_id: "@JackXsparrowlogs",
      text: "📢 <b>New User started the @JackXsparrowbot</b>\n\n" +
            "👤 <b>Name:</b> " + name + "\n" +
      ...
      reply_markup: {
        inline_keyboard: [
          [{ text: "Bot Link", url: "https://t.me/JackXsparrowbot" }]
        ]
      }
    });
  }
